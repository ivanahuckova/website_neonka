...
//Import icons/images
import logoPlaceholder from '../assets/logo_image.svg';
                ...
                <StyledPeopleConatiner>
                    <StyledCard>
                        <div className='image-div'>
                            <img src={logoPlaceholder} alt='Elisa' />
                        </div>
                        <div>
                    ...
                    <StyledCard>
                        <div className='image-div'>
                            <img src={logoPlaceholder} alt='Ivana' />
                        </div>
                        <div>
                    ...
                    <StyledCard>
                        <div className='image-div'>
                            <img src={logoPlaceholder} alt='Novina' />
                        </div>
                        <div>
                    ...
                    <StyledCard>
                        <div className='image-div'>
                            <img src={logoPlaceholder} alt='Samar' />
                        </div>
                        <div>
                    ...
                    <StyledCard>
                        <div className='image-div'>
                            <img src={logoPlaceholder} alt='Sean' />
                        </div>
                        <div>
                    ...
                    <StyledCard>
                        <div className='image-div'>
                            <img src={logoPlaceholder} alt='Thorben' />
                        </div>
                        <div>
